...
Activate a modal without writing JavaScript. Set `data-toggle="modal"` on a app element, like a button, along with a `data-target="#foo"` or `href="#foo"` to target a specific modal to toggle.
